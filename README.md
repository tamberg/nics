# NICs Map
A physical map that shows the [regional internet registry](https://en.wikipedia.org/wiki/Regional_Internet_registry) / [network information center](https://en.wikipedia.org/wiki/InterNIC) responsible for the [IPv4 address space](http://www.iana.org/assignments/ipv4-address-space) of incoming TCP connections on a specific port based on the first byte of the remote IP address.
